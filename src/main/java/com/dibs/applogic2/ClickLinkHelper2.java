...
public class ClickLinkHelper2 extends DriverBasedHelper implements
		ClickLinkHelper {
	...
	@Override
	public void clickOnCustomerSupportLink() {
		pages.searchresultPage.ensurePageLoaded().CustomerSupportLinkClick();
